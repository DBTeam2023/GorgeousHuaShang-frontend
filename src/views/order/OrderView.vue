    ...
    <el-container class="order-container">
      ...
      <el-main class="order-main">
                ...
                <el-table-column label="订单列表" width="1000">
                    ...
                    <el-row class="t-body">
                        ...
                        <el-col class="right-col" :span="3">
                            <el-row class="btn" >
                                <el-button link class="detail-btn" @click="goOrderDetail(row.orderID)">订单详情</el-button>
                            </el-row>
                        </el-col>
                        <!-- 订单操作 -->
                        <el-col class="right-col  btn-col" :span="3">
                            <el-row class="btn">
                                <el-button v-if="row.state === 'wait to pay'" type="primary" @click="goPay(row.orderID)">立即支付</el-button>
                                <el-button v-if="row.state === 'paid'" type="success" @click="finish(row.orderID)">确认收货</el-button>
                            </el-row>
                            <el-row class="btn">
                                <el-button v-if="row.state === 'wait to pay'" type="warning" @click="cancel(row.orderID)">取消订单</el-button>
                                <el-button v-if="row.state === 'order complete' || row.state === 'cancelled'" type="danger" @click="deleteMyOrder(row.orderID)">删除订单</el-button>
                            </el-row>
                        </el-col>
                    </el-row>
                    </template>
        ...
        <el-row class="pagination">
            <el-button type="danger" plain @click="deleteAll" :disabled="activeIndex === 'successPaid' || activeIndex === waitPay">
                删除所选订单
            </el-button>
        </el-row>
        <el-row class="pagination">
